...
glm::mat4 CamUtils::viewMatrix(const Camera& cam, const Transform& transform) noexcept
{
...
[[nodiscard]] constexpr float CamUtils::vfovFromHfov(float hfov_deg) noexcept
{
